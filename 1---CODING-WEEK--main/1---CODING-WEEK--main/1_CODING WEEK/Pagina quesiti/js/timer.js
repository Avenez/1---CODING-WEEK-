...
document.getElementById("risposta1").addEventListener("click", resetTimer);
...
const nextQuestion = function () {
  if (numeroDomanda < questions.length) {
    div2 = document.getElementsByClassName(".risposeMultiple")[1]
    div2.style.display = 'block';
    document.getElementById("domanda").innerText = questions[numeroDomanda].question;
...
const evento = function () {
  const risposte = document.querySelectorAll(".stileDomanda");
